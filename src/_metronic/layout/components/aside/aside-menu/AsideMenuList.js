        ...
        <ul className={`menu-nav ${layoutProps.ulClasses}`}>
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Home/HomeG.svg")} />
            </span>
          ...
          <li className="menu-section ">
            <h4 className="menu-text">Estudiantes</h4>
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">Servicio Social</span>
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">Nuevo Ingreso</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">Archivo Electrónico</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">Casas de estudiantes</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
          ...
          {/* begin::section */}
          <li className="menu-section ">
            <h4 className="menu-text">Tramites</h4>
            <i className="menu-icon flaticon-more-v2"></i>
          </li>
          {/* Titulacion */}
          <li
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">Titulación</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">EGEL</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">Nivel Superior</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">Ovirtual</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">SASE</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
          ...
          >
            ...
            <span className="svg-icon menu-icon">
              ...
              <span className="menu-text">Credencialización</span>
              <i className="menu-arrow"/>
            </NavLink>
            <div className="menu-submenu ">
              <ul className="menu-subnav">
